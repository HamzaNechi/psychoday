...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final response = await http.delete(Uri.parse('$BASE_URL/therapy/deleteOnce/$therapyId'));
...
Future getUserConnected() async{
  ...
  itemBuilder: (context, index) {
    return Dismissible(
      ...
      child: roleUserConnected! =="doctor" ? CellDoctor(games[index]) : MenuItemCard(games[index]),
    );
  },
);
