...
class _SpeechScreenState extends State<SpeechScreen> {
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 1), (timer) {
      ...
      print("angryPercentage: " + angryPercentage.toString() + "%");
                    ...
                    if (SymptomsJson["elevated mood for more than one week"] !=
                      ...
                      setState(() {
                        ...
                        Map<String, dynamic> symptomsObject = {
                          ...
                          "surprisedpercentage": surprisedPercentage,
                          "fearfulpercentage": fearfulPercentage,
                          "disgustedpercentage": disgustedPercentage
                        };
                        //data to send
