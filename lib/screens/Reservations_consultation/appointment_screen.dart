        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return SingleChildScrollView(
              child: DetailBody(userDetail: snapshot.data!),
            );
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<Location>>(
        ...
        builder: (context, snapshot) {
                    ...
                    children: [
                      Container(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            final Uri url = Uri(
                                scheme: 'tel', path: "${userDetail["user"]["phone"]}");
          ...
          context,
          MaterialPageRoute(builder: (context) => TableCalenderDoctor()),
        ),
                      },
                    )
                  ],
